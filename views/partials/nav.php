        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/about" class="<?= urlIs('/about') ? 'bg-gray-950/50 text-white' : 'text=gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 ">About</a>
              <a href="/contact" class="<?= urlIs('/contact') ? 'bg-gray-950/50 text-white' : 'text=gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 ">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
