        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" aria-current="page" class="<?= urlIs('/') ? 'bg-gray-950/50 text-white' : 'text=gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300">Home</a>
              <a href="/about.php" class="<?= urlIs('/about.php') ? 'bg-gray-950/50 text-white' : 'text=gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 ">About</a>
              <a href="/contact.php" class="<?= urlIs('/contact.php') ? 'bg-gray-950/50 text-white' : 'text=gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 ">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
