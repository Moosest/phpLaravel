        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" aria-current="page" class="rounded-md text-gray-300 hover:bg-white/5 hover:text-white px-3 py-2 text-sm font-medium ">Home</a>
              <a href="/about.php" class="rounded-md px-3 py-2 text-sm font-medium bg-gray-950/50 text-white">About</a>
